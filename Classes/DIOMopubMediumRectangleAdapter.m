...
//  DIOMopubMediumRectangleAdapter.m
//  MopubAdapterForiOS
//
...
#import "DIOMopubMediumRectangleAdapter.h"

#import <DIOSDK/DIOController.h>

@interface DIOMopubMediumRectangleAdapter ()

@end

@implementation DIOMopubMediumRectangleAdapter
...
- (void)requestAdWithSize:(CGSize)size customEventInfo:(NSDictionary *)info adMarkup:(NSString *)adMarkup{
    ...
    if (![DIOController sharedInstance].initialized) {
        ...
        [self loadDioMediumRect:placementId];
    }
}

- (void)loadDioMediumRect:(NSString *)placementId{
